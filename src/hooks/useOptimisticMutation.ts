 ...
 */
export interface UseOptimisticMutationOptions<T, TData = any> {
 ...
 */
export interface UseOptimisticMutationReturn<T, TData = any> {
 ...
 * ```
 */
export function useOptimisticMutation<T extends { id: string }, TData = any>({
  currentData,
  mutationFn,
  onSuccess,
  onError,
  ...
  const mutate = useCallback(
    ...
    [mutationFn, onSuccess, onError, context, setOptimisticData]
  )
