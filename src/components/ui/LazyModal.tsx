...
export function LazyModal({
  ...
  // Only create lazy component when modal is opened
  // This prevents loading the component until it's actually needed
  const LazyContent = isOpen ? lazy(loader) : null
